...
while True : 
    ...
    #when user choice is 2 
        ...
        remove_project = str(input("Do you want to remove the project (Yes/No)?")).lower()
        if remove_project == "yes":
            for project in ongoing_projects:
                if project == project_code_to_remove:
                    completed_projects.append(project)
                    available_workers = available_workers + project["number_of_workers"]
    ...
    #when user choice is 4
        ...
        for project in ongoing_projects:
            if project == project_code:
                ...
                number_of_workers = int(input("Number of workers - "))
                project_status = input("Project status(ongoing/on hold/completed) - ")
                update_project = input("Do you want to update the project details (Yes/No)? ").lower()
    ...
    #when user choice is 5
        ...
        if add_project == "yes":
            ongoing_projects.append(add_project)   
